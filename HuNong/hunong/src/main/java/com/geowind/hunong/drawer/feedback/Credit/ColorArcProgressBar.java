...
/**
 * Created by logaxy on 2017/3/25.
 */
...
public class ColorArcProgressBar extends View {
    ...
    public void setLongDegreeColor(String longDegreeColor) {
        this.longDegreeColor = longDegreeColor;
    }

    private String longDegreeColor = "#FFFFFF";

    public void setShortDegreeColor(String shortDegreeColor) {
        this.shortDegreeColor = shortDegreeColor;
    }

    private String shortDegreeColor = "#FFFFFF";

    public void setBgArcColor(String bgArcColor) {
        this.bgArcColor = bgArcColor;
    }

    public void setValueTextColor(String valueTextColor){
        int color=Color.parseColor(valueTextColor);
